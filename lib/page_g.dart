...
class PageG extends StatefulWidget {
  @override
  PageGState createState() => PageGState();
}

class PageGState extends State<PageG> {
  List<Item> _data = generateItems(3);
  int _openPanelIndex = 0; // 初期値は -1 で、全てのパネルが閉じている状態を表します。
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView( // ListViewの代わりにSingleChildScrollViewを使用
